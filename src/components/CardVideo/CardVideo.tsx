  ...
  return (
    ...
    >
      ...
      <div className={`${compact ? 'px-3 py-2.5' : 'px-3 py-3'} shrink-0`}>
        <p className={`font-serif font-medium leading-[1.35] uppercase tracking-wide text-white transition-colors duration-200 ${compact ? 'line-clamp-2 text-sm' : 'line-clamp-3'} ${featured ? 'text-xl' : ''}`}>
          {video.titulo}
        </p>
      </div>
    </a>
