...
export function MobileSidebarButton({ onClick }: MobileSidebarButtonProps) {
  return (
    <Button
      ...
      className="fixed bottom-5 right-5 z-40 border-boca-gold/40 bg-boca-blue-mid/95 px-5 py-4 text-white shadow-[0_18px_40px_rgba(0,0,0,0.35)] backdrop-blur-sm active:scale-95"
    >
