...
function FotoSection({
  user,
  onUploadAvatar,
}: Pick<ConfiguracionProps, "user" | "onUploadAvatar">) {
...
function UsernameSection({
  user,
  onUpdateDisplayName,
}: Pick<ConfiguracionProps, "user" | "onUpdateDisplayName">) {
...
function EmailSection({
  user,
  onUpdateEmail,
}: Pick<ConfiguracionProps, "user" | "onUpdateEmail">) {
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <SaveButton
          loading={loading}
          disabled={!value || value === user?.email}
...
function PasswordSection({
  onUpdatePassword,
}: Pick<ConfiguracionProps, "onUpdatePassword">) {
