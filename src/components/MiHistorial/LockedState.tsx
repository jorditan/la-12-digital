  ...
  <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
    <div className="relative mb-6">
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(0,52,126,0.6) 0%, rgba(0,21,41,0.9) 100%)",
        }}
      >
        <svg
          viewBox="0 0 40 48"
    ...
    <h2 className="type-section-title text-white mb-2 font-serif italic">
      Registrá tu historial
    </h2>
    ...
    <div className="flex gap-2 mt-10 opacity-30">
      {[...Array(5)].map((_, i) => (
        <div
          key={i}
          className="w-1.5 h-1.5 rounded-full bg-boca-gold"
