  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'overlay-game': 'linear-gradient(to top, #031428 40%, transparent 100%)',
        'pitch-field': 'linear-gradient(180deg, #0d5c2a 0%, #0a4a22 100%)',
        'app-bg': 'linear-gradient(166.99deg, #001529 1%, rgb(0,35,68) 72.17%, rgb(0,62,121) 101.68%, rgb(0,73,143) 111.31%)',
      },
    },
  },
  plugins: [],
